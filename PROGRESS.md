# Monosodium Desktop — progress log

Milestone, feature, and live-bugfix history for this project. Moved out of `CLAUDE.md` so it
is not loaded into every session. Read it for the "why" behind a feature or to check whether a
bug has been seen before.
